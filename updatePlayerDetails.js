function main() {
    ...
    fetch('https://fantasy.premierleague.com/api/bootstrap-static/').then(res => res.json()).then(data => {
        loopPlayers(data);
    })
    ...
    function loopPlayers(data) {
        ...
        for (let i = 0; i < data.elements.length; i++) {
            fetch(`https://fantasy.premierleague.com/api/element-summary/${
                data.elements[i].id
    ...
    function writeArray() {
        ...
        try { // convert JSON object to a string
